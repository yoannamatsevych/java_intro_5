...
//        System.out.println("There are " + counter + " vowel letter in this full name");
        ...
        int sumOfTheGivenNumber = 0;
            do {
                int number1 = ScannerHelper.getAnNumber();
                sumOfTheGivenNumber += number1;
                if (sumOfTheGivenNumber >= 100 && number1 < 100) System.out.println("Sum of the entered numbers is at least 100");
                else if (number1 >= 100) System.out.println("Number is already more than 100");
