...
public class Practice02_FindClosestToN {
    public static void main(String[] args) {
      ...
      //  System.out.println(findClosest(new ArrayList<>(Arrays.asList(7, 7, 7, 7)), 7)); // Exception
       ...
       //System.out.println(findClosest(new ArrayList<>(Arrays.asList()), 3)); // Exception
        ...
        System.out.println(findClosest(new ArrayList<>(Arrays.asList(8, 8)), 9)); // 8
    }

    /*
    Assume you are given a collection of numbers and then number called as n
